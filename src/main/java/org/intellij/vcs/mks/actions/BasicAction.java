...
//		}
		...
		// todo replaceable by  ServiceManager.getService(project, MksVcs.class);?
...
//		}
	...
	private void execute(final Project project, VirtualFile[] files, List<VcsException> exceptions, DataContext dataContext) {
	 ...
	 * @param exceptions
	 */
	protected void perform(Project project, VirtualFile[] affectedFiles, DataContext dataContext, List<VcsException> exceptions) {
		ProjectLevelVcsManager projectLevelVcsManager = ProjectLevelVcsManager.getInstance(project);
