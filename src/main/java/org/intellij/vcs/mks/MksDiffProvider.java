...
public class MksDiffProvider implements DiffProvider {
	...
	/**
	 * The method is used to check whether there were any new commits under some root. It can return null -
	 * than it would mean that there's no information about whether something had changed (result of this method
	 * invocation is cached and compared with next invocation's result). <br/>
	 * So, return null.
	 *
	 * @param vcsRoot
