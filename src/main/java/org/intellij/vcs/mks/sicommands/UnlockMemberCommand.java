...
public class UnlockMemberCommand extends SiCLICommand {
    ...
    public UnlockMemberCommand(@NotNull List<VcsException> errors, @NotNull MksCLIConfiguration mksCLIConfiguration, @NotNull MksSandboxInfo sandbox, String... members) {
        super(errors, mksCLIConfiguration, COMMAND, createArray(members, "--sandbox=" + sandbox.sandboxPath, "--nobreaklock"));
