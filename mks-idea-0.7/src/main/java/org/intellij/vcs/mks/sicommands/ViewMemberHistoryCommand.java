...
public class ViewMemberHistoryCommand extends SiCLICommand {
    ...
    private Date parseDate(String date) throws VcsException {
        try {
            ...
            throw new VcsException("unknown date format for " + date + " (expected [" + mksCLIConfiguration.getDatePattern() + "]). " +
                    "This may be an encoding issue, encoding used was " + mksCLIConfiguration.getMksSiEncoding(COMMAND));
        }
    }
