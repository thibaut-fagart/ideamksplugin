...
public interface SandboxCache
    extends ModuleRootListener, SandboxListListener, VcsListener {
     ...
     *         file system
     */
    @Nullable MksSandboxInfo getSandboxInfo(@NotNull VirtualFile virtualFile);
     ...
     */
    @NotNull Set<MksSandboxInfo> getSandboxesIntersecting(
     ...
     */
    @Nullable MksSandboxInfo getSubSandbox(@NotNull VirtualFile virtualFile);
}
