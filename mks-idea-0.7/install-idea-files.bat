...
call mvn install:install-file -Dclassifier=sources -DgroupId=%IDEA_GROUP_ID% -Dpackaging=zip -Dfile="%IDEA_HOME%\lib\src\src_openapi.zip" -DartifactId=openapi -Dversion=%IDEA_VERSION%
