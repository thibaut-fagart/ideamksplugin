...
public class ViewSandboxLocalChangesOrLockedCommand extends AbstractViewSandboxCommand {
     ...
     */
    public ViewSandboxLocalChangesOrLockedCommand(final List<VcsException> errors, final MksCLIConfiguration mksCLIConfiguration,
                                                  final String username, final String sandboxPath) {
        super(errors, mksCLIConfiguration, sandboxPath,/* "--filter=changed",*/"--filter=changed:working,deferred,locked:" + username);
