...
// Source File Name:   ResynchronizeMembersAction.java
...
/*  31*/		catch(TriclopsException e)
        		{
/*  32*/			throw new VcsException("Resynchronize: Unable to access sandbox.");
        		}
...
/*  40*/		catch(TriclopsException e)
        		{
/*  41*/			throw new VcsException("Resynchronize: Unable to get member(s).");
        		}
/*  45*/		try
        		{
/*  45*/			if(MksVcs.CLIENT != null)
        			{
/*  46*/				members.resyncMembers(0);
...
/*  52*/				throw new VcsException("Resynchronize Error: " + message);
        		}
/*  56*/		WindowManager.getInstance().getStatusBar(project).setInfo("Resynchronize complete.");
        	}

        	protected String getActionName(AbstractVcs vcs)
        	{
/*  60*/		return "Resynchronize";
        	}
