...
/*  31*/		catch(TriclopsException e)
        		{
/*  32*/			throw new VcsException("Check Out: Sandbox is invalid.");
        		}
...
/*  40*/		catch(TriclopsException e)
        		{
/*  41*/			throw new VcsException("Check Out: Unable to get member status from sandbox.");
        		}
/*  45*/		try
        		{
/*  45*/			if(MksVcs.CLIENT != null)
        			{
/*  46*/				members.checkoutMembers(0);
...
/*  52*/				throw new VcsException("Checkout Error: " + message);
        		}
/*  56*/		WindowManager.getInstance().getStatusBar(project).setInfo("CheckOut complete.");
        	}
