...
public class ViewSandboxRemoteChangesCommand extends AbstractViewSandboxCommand {
	...
	public ViewSandboxRemoteChangesCommand(final List<VcsException> errors, final EncodingProvider encodingProvider,
										   final String sandboxPath) {
		super(errors, encodingProvider, sandboxPath,/* "--filter=changed",*/"--filter=changed:sync,changed:newmem");
	}
